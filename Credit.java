...
public class Credit implements ActionListener {
  ...
  Credit() {
    ...
    // Norick
    JLabel background2;
    ImageIcon img2 = new ImageIcon("image/N1.jpg");
    ...
    tutorText.setForeground(new Color(255, 255, 255));              // Set warna
    ...
    tutorText2.setForeground(new Color(255, 255, 255)); 
    ...
    tutorText22.setForeground(new Color(255, 255, 255));
    ...
    tutorText3.setForeground(new Color(255, 255, 255)); 
    ...
    tutorText33.setForeground(new Color(255, 255, 255)); 
    ...
    tutorText4.setForeground(new Color(255, 255, 255)); 
    ...
    tutorText44.setForeground(new Color(255, 255, 255)); 
    ...
    tutorTextM.setForeground(new Color(255, 255, 255));
